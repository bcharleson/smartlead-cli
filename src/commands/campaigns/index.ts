...
const scheduleCommand: CommandDefinition = {
  ...
  inputSchema: z.object({
    ...
    max_new_leads_per_day: z.coerce.number().optional().describe('Maximum new leads emailed per day'),
  ...
  cliMappings: {
    ...
    options: [
      ...
      { field: 'max_new_leads_per_day', flags: '--max-leads-per-day <n>', description: 'Max new leads per day' },
